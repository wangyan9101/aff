	  ...
	  _createClass(App, [{
	    ...
	    value: function updateMulti() {
	      ...
	      if (!this.patching) {
	        ...
	        var _patch = this.patch(this.element, this.nodeFunc(this.state), this.node);
	        ...
	        while (this.updated) {
	          ...
	          var _patch3 = this.patch(this.element, this.nodeFunc(this.state), this.node);
	    ...
	    value: function patchNode(lastElement, node, lastNode) {
	      ...
	      for (var _i2 = childLen; _i2 < lastChildLen; _i2++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var logUpdates = exports.logUpdates = (0, _event.on)('afterUpdate:__log_updates', function (state) {
