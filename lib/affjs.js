...
/***/ function(module, exports, __webpack_require__) {
	...
	function make_app(element, node_func) {
	  var init_state = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
	  var before_update = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function () {};
	  var after_update = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : function () {};
	
	  var state = init_state;
	  (0, _state.freeze_all)(state);
	  var node = void 0;
	  var patching = void 0;
	  var updated = void 0;
	  function update() {
	    ...
	    before_update.apply(undefined, [state].concat(args));
	    state = _state.copy_update.apply(undefined, [state].concat(args));
	    after_update.apply(undefined, [state].concat(args));
	    if (!patching) {
	      patching = true;
	      updated = false;
	
	      var _patch = (0, _dom.patch)(element, node_func(state, update), node);
	      ...
	      while (updated) {
	        ...
	        var _patch3 = (0, _dom.patch)(element, node_func(state, update), node);
	  ...
	  function tap(fn) {
	    var res = fn(state);
	    if (res) {
	      update.apply(undefined, _toConsumableArray(Array.isArray(res) ? res : [res]));
	    }
	  }
	  update('__start', true);
	  return {
