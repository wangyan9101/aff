	...
	var Thunk = function () {
	  ...
	  _createClass(Thunk, [{
	    ...
	    value: function setArgs(args) {
	      this.args = args;
	      this.arg_versions = this.args.map(function (arg) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function equal(a, b) {
	  var aVer = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
	  var bVer = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
