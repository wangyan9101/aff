	...
	var App = exports.App = function () {
	  ...
	  _createClass(App, [{
	    ...
	    value: function patchNode(last_element, node, last_node) {
	      ...
	      // class
	      for (var _key11 in node.class) {
	        // should update
	        if (!last_node.class || node.class[_key11] != last_node.class[_key11]) {
	          if (node.class[_key11]) {
	      ...
	      for (var _key12 in last_node.class) {
	        if (!node.class || !(_key12 in node.class)) {
