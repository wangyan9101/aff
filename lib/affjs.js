	  ...
	  _createClass(App, [{
	    ...
	    value: function update() {
	      ...
	      if (!this.patching) {
	        ...
	        var _patch = this.patch(this.element, this.node_func(this.state, this.update.bind(this)), this.node);
	        ...
	        while (this.updated) {
	          ...
	          var _patch3 = this.patch(this.element, this.node_func(this.state, this.update.bind(this)), this.node);
