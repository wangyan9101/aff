	  ...
	  _createClass(App, [{
	    ...
	    value: function setupUses(obj, path, scopes) {
	      ...
	      for (var _key5 in obj) {
	        ...
	        _p2.push(_key5);
	        this.setupUses(obj[_key5], _p2, scopes);
	      }
	    }
	  }, {
	    key: 'addEvent',
	    ...
	    value: function updateMulti() {
	      ...
	      if (!this.patching) {
	        ...
	        var _patch = this.patch(this.element, this.nodeFunc(this.state, this), this.node);
	        ...
	        while (this.updated) {
	          ...
	          var _patch3 = this.patch(this.element, this.nodeFunc(this.state, this), this.node);
	    ...
	    value: function patch(lastElement, node, lastNode) {
	      ...
	      || node.tag != lastNode.tag) {
	        var element = node.toElement(undefined, this);
	    ...
	    value: function patchNode(lastElement, node, lastNode) {
	      ...
	      // diff object
	          ...
	          if (node.style !== null) {
	            for (var _key10 in node.style) {
	              if (!lastNode.style || node.style[_key10] != lastNode.style[_key10]) {
	                lastElement.style[_key10] = node.style[_key10];
	              }
	            }
	          }
	          if (lastNode.style !== null) {
	            for (var _key11 in lastNode.style) {
	              if (!node.style || !(_key11 in node.style)) {
	                lastElement.style[_key11] = '';
	              }
	            }
	          }
	        }
	      ...
	      for (var _key12 in node.classList) {
	        // should update
	        if (!lastNode.classList || node.classList[_key12] != lastNode.classList[_key12]) {
	      ...
	      for (var _key14 in node.attributes) {
	        if (!lastNode.attributes || node.attributes[_key14] != lastNode.attributes[_key14]) {
	          var value = node.attributes[_key14];
	          var valueType = typeof value === 'undefined' ? 'undefined' : _typeof(value);
	          if (valueType == 'string' || valueType == 'number') {
	            lastElement.setAttribute(_key14, value);
	            lastElement[_key14] = value;
	          } else if (valueType == 'boolean') {
	            if (value) {
	              lastElement.setAttribute(_key14, true);
	              lastElement[_key14] = true;
	            } else {
	              lastElement.removeAttribute(_key14);
	              lastElement[_key14] = false;
	            }
	          }
	        }
	      }
	      for (var _key15 in lastNode.attributes) {
	        if (!node.attributes || !(_key15 in node.attributes)) {
	          lastElement.removeAttribute(_key15);
	          lastElement[_key15] = undefined;
	        }
	      }
	      ...
	      for (var _key16 in node.events) {
	        var k = elementSetEvent(lastElement, _key16, node.events[_key16].bind(node));
	        eventKeys[k] = true;
	      }
	      ...
	      for (var i = 0; i < childLen; i++) {
	        var _patch5 = this.patch(childElements[i], node.children[i], lastNode && lastNode.children ? lastNode.children[i] : undefined),
	      ...
	      for (var _i3 = childLen; _i3 < lastChildLen; _i3++) {
	        ...
	        if (key == 'id' || key == 'innerHTML') {
	          ...
	          if (typeof property == 'string') {
	            ...
	            if (Array.isArray(property)) {
	              for (var _i4 = 0; _i4 < property.length; _i4++) {
	                this.classList[property[_i4]] = true;
	              }
	            } else {
	          ...
	          if (this.style === null) {
	            ...
	            if (styleType === 'string') {
	              ...
	              for (var _key20 in style) {
	                this.style[_key20] = style[_key20];
	              }
	            }
	          }
	    ...
	    value: function toElement(name, app) {
	      ...
	      if (this.text !== null) {
	        ...
	        if (app && app.elementCache[this.tag] && app.elementCache[this.tag].length > 0) {
	          var _ret = function () {
	            var _app$elementCache$tag = app.elementCache[_this.tag].pop(),
	                _app$elementCache$tag2 = _slicedToArray(_app$elementCache$tag, 2),
	                element = _app$elementCache$tag2[0],
	                lastNode = _app$elementCache$tag2[1];
	
	            var node = void 0;
	
	            var _app$patchNode = app.patchNode(element, _this, lastNode);
	      ...
	      if (this.events !== null) {
	        for (var _key22 in this.events) {
	          ...
	          elementSetEvent(element, _key22, this.events[_key22].bind(this));
	        }
	      }
	...
	var MutableState = exports.MutableState = function (_State) {
	  ...
	  _createClass(MutableState, [{
	    ...
	    value: function argsChanged(arg, lastArg) {
	      ...
	      if (arg === lastArg && (typeof arg === 'undefined' ? 'undefined' : _typeof(arg)) === 'object' && arg != null && arg.__aff_use_keys && arg.__aff_tick_update_at != this.patchTick) {
	      ...
	      // array
	        ...
	        // deep compare object
	            ...
	            for (var _key3 in arg) {
	              if (this.argsChanged(arg[_key3], lastArg[_key3])) {
	                return true;
	              }
	            }
	          }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function CloseButton(debugState) {
	  return (0, _tags.button)((0, _tagged.css)(_templateObject24), (0, _event.on)('click', function () {
	...
	function PanelPosition(debugState) {
	  function makeButton(text, left, right, top, bottom) {
	    return (0, _tags.button)((0, _tagged.css)(_templateObject25), text, (0, _event.on)('click', function () {
