	  ...
	  _createClass(App, [{
	    ...
	    value: function setupState(obj) {
	      ...
	      var _loop = function _loop(_key5) {
	        ...
	        if (subState instanceof _state2.Updater) {
	        ...
	        } else if (subState instanceof _state2.StateWrapper) {
	          var _name = subState.name;
	          // search update path
	          var _found = false;
	          for (var _i4 = scopes.length - 1; _i4 >= 0; _i4--) {
	            var _bindings3 = scopes[_i4];
	            if (_name in _bindings3) {
	              var _ret4 = function () {
	                // found
	                _found = true;
	                var updatePath = _bindings3[_name].slice(0);
	                obj[_key5] = function () {
	                  subState.func(app.get(updatePath)).apply(undefined, arguments);
	                };
	                return 'break';
	              }();
	          ...
	          _p2.push(_key5);
	          _this.setupState(subState, _p2, scopes);
	        }
	      };
	    ...
	    value: function updateMulti() {
	      ...
	      if (!this.patching) {
	        ...
	        if (this.jobs.length > 0) {
	          for (var _i5 = this.jobs.length - 1; _i5 >= 0; _i5--) {
	            this.jobs[_i5]();
	          }
	          this.jobs = [];
	        }
	    ...
	    value: function patchNode(lastElement, node, lastNode) {
	      ...
	      for (var _i6 = childLen; _i6 < lastChildLen; _i6++) {
	        var _elem3 = lastElement.removeChild(lastElement.childNodes[childLen]);
	        this.cacheNode(_elem3, lastNode.children[_i6]);
	      }
...
/***/ function(module, exports) {
	...
	function StateWrapper(name, func) {
	  this.name = name;
	  this.func = func;
	}
	
	function withState(name, func) {
