	  ...
	  _createClass(App, [{
	    ...
	    value: function setupState(obj) {
	      ...
	      for (var key in obj) {
	        ...
	        // search in scopes
	        var found = false;
	        for (var _i = scopes.length - 1; _i >= 0; _i--) {
	          ...
	          while (setupPath.length > stopLen) {
	            setGetter(this.get(setupPath), key, _bindings[name]);
	            setupPath.pop();
	          }
	      ...
	      for (var _key3 in obj) {
	        var _subState = obj[_key3];
	
	        // setup updater
	        if (_subState instanceof _state2.Updater) {
	          (function () {
	            var name = _subState.name;
	            var func = _subState.func;
	            // search update path
	            var found = false;
	            for (var _i2 = scopes.length - 1; _i2 >= 0; _i2--) {
	              var _bindings2 = scopes[_i2];
	                ...
	                var _ret2 = function () {
	                  ...
	                  if (func) {
	                    obj[_key3] = function () {
	                      ...
	                      func.apply(undefined, [function () {
	                        for (var _len3 = arguments.length, updateArgs = Array(_len3), _key5 = 0; _key5 < _len3; _key5++) {
	                          updateArgs[_key5] = arguments[_key5];
	                        }
	
	                        return app.update.apply(app, _toConsumableArray(updatePath).concat(updateArgs));
	                      }].concat(args));
	                    };
	                  } else {
	                    obj[_key3] = function () {
	                      ...
	                      app.update.apply(app, _toConsumableArray(updatePath).concat(args));
	                    };
	                  }
	                  return 'break';
	                }();
	    ...
	    value: function dispatchEvent(type) {
	      for (var _len5 = arguments.length, args = Array(_len5 > 1 ? _len5 - 1 : 0), _key7 = 1; _key7 < _len5; _key7++) {
	    ...
	    value: function updateMulti() {
	      ...
	      if (!this.patching) {
	        ...
	        if (this.jobs.length > 0) {
	          for (var _i3 = this.jobs.length - 1; _i3 >= 0; _i3--) {
	            this.jobs[_i3]();
	          }
	          this.jobs = [];
	        }
