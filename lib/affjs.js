	      ...
	      if (node.children && last_node.children) {
	        ...
	        for (var _i2 = common_length, l = node.children.length; _i2 < l; _i2++) {
	          if (!node.children[_i2] || !node.children[_i2].toElement) {
	            ...
	            last_element.appendChild(node.children[_i2].toElement(undefined, this));
	          }
	        }
	        // delete
	        ...
	        for (var _i4 = 0, _l2 = node.children.length; _i4 < _l2; _i4++) {
	          if (!node.children[_i4] || !node.children[_i4].toElement) {
	            ...
	            last_element.appendChild(node.children[_i4].toElement(undefined, this));
	          }
	        }
	    ...
	    value: function toElement(name, app) {
	      ...
	      if (this.text !== null) {
	        ...
	        if (app && app.element_cache[this.tag].length > 0) {
	          ...
	          return app.patch(_element, this, last_node)[0];
	        }
