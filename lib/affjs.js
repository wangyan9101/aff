...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = exports.App = function () {
	  ...
	  _createClass(App, [{
	    ...
	    value: function patchNode(lastElement, node, lastNode) {
	      ...
	      for (var i = 0; i < childLen; i++) {
	        ...
	        if (child.key && lastNode && lastNode.children && lastNode.children[i] && lastNode.children[i].key != child.key) {
	          ...
	          var _elem = _result2[0];
	          if (!childElements[i]) {
	            lastElement.appendChild(_elem);
	          }
	        }
	      }
	      var lastChildLen = lastNode && lastNode.children ? lastNode.children.length : 0;
	      for (var _i4 = childLen; _i4 < lastChildLen; _i4++) {
	        var _elem2 = lastElement.removeChild(lastElement.childNodes[childLen]);
	        this.cacheElement(_elem2, lastNode.children[_i4]);
	      }
	    ...
	    key: 'cacheElement',
	    value: function cacheElement(element, node) {
	...
	function t() {
	  ...
	  switch (_typeof(args[0])) {
	    ...
	    case 'function':
	      ...
	      thunk.args = [];
	      for (var _i5 = 1; _i5 < args.length; _i5++) {
	        var _arg = args[_i5];
	        ...
	        if (key == 'id' || key == 'innerHTML') {
	          ...
	          if (typeof property == 'string') {
	            ...
	            if (Array.isArray(property)) {
	              for (var _i6 = 0; _i6 < property.length; _i6++) {
	                this.classList[property[_i6]] = true;
	              }
	            } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateObject = _taggedTemplateLiteral(['\n      list-style: none;\n    '], ['\n      list-style: none;\n    ']),
	    ...
	    _templateObject25 = _taggedTemplateLiteral(['#close-debug-panel'], ['#close-debug-panel']),
	    _templateObject26 = _taggedTemplateLiteral(['\n      margin: 10px 0;\n    '], ['\n      margin: 10px 0;\n    ']),
	    _templateObject27 = _taggedTemplateLiteral(['#panel-position-', ''], ['#panel-position-', '']),
	...
	function Updates(updates, debugStatePath) {
	  return (0, _tags.div)((0, _tagged.css)(_templateObject13), function () {
	    ...
	    var _loop2 = function _loop2(i) {
	      ...
	      ret.push((0, _app.t)(UpdateLogEntry, (0, _tagged.key)(_templateObject20, log.key), log));
	    };
	...
	function UpdateLogEntry(log) {
	  return (0, _tags.div)((0, _tagged.css)(_templateObject21), (0, _tagged.key)(_templateObject20, log.key), (0, _tags.span)('tick: ', log.tick, (0, _tagged.css)(_templateObject22)), log.args.map(function (arg, i) {
	    return (0, _tags.span)((0, _tags.span)((0, _tagged.css)(_templateObject23), function () {
	...
	function formatArg(arg) {
	  if ((typeof arg === 'undefined' ? 'undefined' : _typeof(arg)) === 'object' && arg.__is_op) {
	    return [(0, _tags.span)(arg.op, (0, _tagged.css)(_templateObject24)), arg.args ? [': ', function () {
	      var ret = [];
	...
	function CloseButton(debugState) {
	  return (0, _tags.button)((0, _tagged.$)(_templateObject25), (0, _tagged.css)(_templateObject26), (0, _event.on)('click', function () {
	...
	function PanelPosition(debugState) {
	  function makeButton(text, left, right, top, bottom) {
	    return (0, _tags.button)((0, _tagged.$)(_templateObject27, text), (0, _tagged.css)(_templateObject28), text, (0, _event.on)('click', function () {
